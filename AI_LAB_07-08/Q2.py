...
print("\nno nodes pruned in this instance\n(implementation works, have tested with other values, check Q3)\npruning reduces computation by not checking min value if callee is maxPlayer\n(and vice versa) avoiding redundant computation and improving efficiency")
